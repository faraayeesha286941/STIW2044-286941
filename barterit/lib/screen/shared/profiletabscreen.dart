...
import 'package:barterit/screen/shared/loginscreen.dart';
import 'package:barterit/screen/shared/registrationscreen.dart';
...
class _ProfileTabScreenState extends State<ProfileTabScreen> {
    ...
    builder: (context, snapshot) {
      if (snapshot.connectionState == ConnectionState.waiting) {
        ...
        return CachedNetworkImage(
          imageUrl: "${MyConfig().SERVER}/barterit/assets/profile/${widget.user.id}.png?v=$val",
          placeholder: (context, url) => const LinearProgressIndicator(),
          errorWidget: (context, url, error) {
            return Image.network(
              "${MyConfig().SERVER}/barterit/assets/profile/0.png",
              scale: 2,
            );
          },
        );
  ...
  try {
    final response = await http.head(
      Uri.parse("${MyConfig().SERVER}/barterit/assets/profile/${widget.user.id}.png?v=$val"),
    );
